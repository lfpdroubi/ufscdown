...
De acordo com @ibge1993, tabela é uma forma não discursiva de apresentar informações em que os números representam a informação central. 
...
O código pode ser visto no Apêndice \@ref(appendix-a).
...
kable(dados, format = "latex", booktabs = TRUE,
  ...
  footnote(general = "PIB em bilhões de reais. ")
```
