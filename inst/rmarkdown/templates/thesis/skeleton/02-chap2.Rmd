...
subseções conforme a NBR 6024 [-@NBR6024:2012] - ver figura \@ref(fig:imagem).

Quanto à sua estrutura e projeto gráfico, segue as recomendações da \gls{ABNT} 
para preparação de trabalhos acadêmicos, a NBR 14724 [-@NBR14724:2011].
...
Pode-se adotar uma entrelinha maior do que a usada no texto [@NBR14724:2011].
